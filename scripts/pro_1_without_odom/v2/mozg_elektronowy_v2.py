...
def manager(data):
	...
	if(data.z == 0):
		...
		if(STATE == 2): return # nie rob obrotu drugi raz z rzedu
		STATE = 2
		working = True
		...
		if(STATE == 6): return # nie rob obrotu drugi raz z rzedu
		STATE = 6
		working = True
		...
		if(STATE == 7): return # nie rob obrotu drugi raz z rzedu
		STATE = 7
		working = True
		...
		if(STATE == 8): return # nie rob kwadratu drugi raz z rzedu
		STATE = 8
		calcToPoint(data) # jesli po wykonaniu tej funkcji working==True, tzn ze przyjal te robote
		if(working):
